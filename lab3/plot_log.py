...
if __name__ == '__main__':
    ...
    iter_num, mean, maximum, start_idx, win_rate, term_rate = parse_log(args.log)
    plt.clf()
    ...
    plt.plot(iter_num, mean, label='mean score')
    plt.plot(iter_num, maximum, label='maximum score')
    plt.xlabel('Episodes')
    plt.ylabel('Score')
    plt.legend()
    plt.grid()
